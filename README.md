...
A [Vite](https://github.com/vitejs/vite) plugin that integrates [PurgeCSS](https://github.com/FullHuman/purgecss) with [Laravel 11/10/9](https://github.com/laravel/laravel) template assets (currently updated to laravel/laravel@11.0.7).
